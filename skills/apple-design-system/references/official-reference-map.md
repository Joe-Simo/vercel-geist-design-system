...
Use current official Apple Developer pages as source-of-truth references. These
URLs were selected because they are official Apple sources; re-open the relevant
page in the current turn before strict claims. If a page moves or redirects,
search only `developer.apple.com/design`, `developer.apple.com/documentation`,
official Apple Developer App Store/marketing pages, or `apple.com/legal`, and
record the actual official URL used.
...
- Foundations index: `https://developer.apple.com/design/human-interface-guidelines/foundations`
- Patterns index: `https://developer.apple.com/design/human-interface-guidelines/patterns`
- Components index: `https://developer.apple.com/design/human-interface-guidelines/components/`
- Inputs index: `https://developer.apple.com/design/human-interface-guidelines/inputs`
- Technologies index: `https://developer.apple.com/design/human-interface-guidelines/technologies`
...
- Interface Fundamentals technology overview: `https://developer.apple.com/documentation/technologyoverviews/interface-fundamentals`
...
- SF Symbols in HIG: `https://developer.apple.com/design/human-interface-guidelines/sf-symbols`
...
- Developer agreements/terms, license and legal support only: `https://developer.apple.com/support/terms`
- Apple Design Resources License, license and legal support only: `https://developer.apple.com/support/downloads/terms/apple-design-resources/Apple-Design-Resources-License-20230621-English.pdf`
...
- Windows/windowing: `https://developer.apple.com/design/human-interface-guidelines/windows`
...
Open the concrete matching page before designing or coding a component. Do not
...
Use these only for privacy, App Store, marketing, asset, badge, trademark, and
...
- If an expected Apple page returns 404, do not add or cite it. Search current
  official Apple docs, Apple Developer App Store/marketing pages, or Apple legal
  pages as appropriate, then cite the resolved official page.
- If a listed page redirects, record the final canonical Apple URL in Docs
  Evidence and update the local map when editing the skill.
- Archived Apple docs and old PDFs are fallback context only when no current
  Apple Developer page exists for the topic.
- Third-party UI kits, Figma community files, blog posts, screenshots, and
  cloned app screens never satisfy Docs Evidence.
